...
import numpy as np
class PairwiseCoupling(BaseEstimator,ClassifierMixin):
    def __init__(self, classes=3, seed=42, baselearner=LogisticRegression(), kwargs={}):
        self.nclasses=classes
        self.seed=seed
        self.baselearner_class=baselearner.__class__
        self.kwargs=kwargs
        self.params = {'classes': classes, 'seed': seed, 'baselearner': baselearner, 'kwargs': kwargs}
