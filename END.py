...
import random
import numpy as np
class EnsembleND(BaseEstimator,ClassifierMixin):
    def __init__(self, number_of_nds, number_of_classes, model_type_ins, kwargs, generator_String='random', random_state=1):
        self.number_of_nds = number_of_nds
        self.number_of_classes=number_of_classes
        self.model_type=model_type_ins.__class__
        self.kwargs=kwargs
        self.generator_str = generator_String
        self.params = {'number_of_nds': number_of_nds, 'number_of_classes': number_of_classes, 'model_type_ins': model_type_ins, 'kwargs': kwargs, 'generator_String': generator_String, 'random_state': random_state}
