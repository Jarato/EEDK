...
import numpy as np
class PairwiseCoupling_NB(BaseEstimator,ClassifierMixin):
    def __init__(self, classes=3, seed=42, var_smoothing=0.0000001):
        self.nclasses=classes
        self.seed=seed
        self.baselearner_class=GaussianNB
        self.kwargs={'var_smoothing': var_smoothing}
        self.params = {'classes': classes, 'seed': seed, 'var_smoothing': var_smoothing}
