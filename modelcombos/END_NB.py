...
import random
import numpy as np
class EnsembleND_NB(BaseEstimator):
    def __init__(self, number_of_nds, number_of_classes, var_smoothing=0.0000001, generator_String='random', random_state=1):
        self.number_of_nds = number_of_nds
        self.number_of_classes=number_of_classes
        self.model_type=GaussianNB
        self.kwargs={'var_smoothing': var_smoothing}
        self.generator_str = generator_String
        self.params = {'number_of_nds': number_of_nds, 'number_of_classes': number_of_classes, 'var_smoothing': var_smoothing, 'generator_String': generator_String, 'random_state': random_state}
    ...
    def set_params(self, **params):
        #print(params)
        self.kwargs = params;
        self.params['var_smoothing'] = params['var_smoothing']
        return self